...
class CreatePostEmployee extends StatefulWidget {
  final String image;
  var imageFromGallery;
  var videoFromGallery;
  var videoFromCamera;
  CreatePostEmployee({this.image,
    this.imageFromGallery,
    this.videoFromGallery,
    this.videoFromCamera
  });
  @override
  _CreatePostEmployeeState createState() => _CreatePostEmployeeState();
}

class _CreatePostEmployeeState extends State<CreatePostEmployee> {
                        ...
                        Container(
                          ...
                          child: TextField(
                            ...
                            decoration: InputDecoration(
                                ...
                                focusedBorder: InputBorder.none,
                                enabledBorder: InputBorder.none,
                                hintText: 'Write your skills here. . .',
                                hintStyle: GoogleFonts.robotoMono(
                                    color: Color(0xffE8E4E4),
                                    fontWeight: FontWeight.w300,
                                    fontSize: SizeConfig.textMultiplier * 2
