import 'package:assisme/ScreensEmployee/DashBoardEmployee.dart';
import 'package:assisme/ScreensEmployee/ExploreEmployee.dart';
import 'package:assisme/ScreensEmployee/HomePageEmployee.dart';
...
import 'MessageEmployee.dart';
import 'RecordCameraEmployee.dart';

class EmployeeNavBar extends StatefulWidget {
  @override
  _EmployeeNavBarState createState() => _EmployeeNavBarState();
}
    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: PageView(
          ...
          children: <Widget>[
            HomePageEmployee(),
            ExploreEmployeeScreen(),
            MessagesEmployee(),
            DashBoardProfileEmployee()
