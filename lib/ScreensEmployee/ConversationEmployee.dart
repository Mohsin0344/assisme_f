...
class ConversationEmployee extends StatefulWidget {
  @override
  _ConversationEmployeeState createState() => _ConversationEmployeeState();
}

class _ConversationEmployeeState extends State<ConversationEmployee> {
