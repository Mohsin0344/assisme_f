...
import 'package:assisme/Screens/SignUpEmplyee_final.dart';
import 'package:assisme/Screens/Signup_Category.dart';
import 'package:assisme/size_config.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class SignupScreen_employee extends StatefulWidget {
  @override
  _SignupScreen_employeeState createState() => _SignupScreen_employeeState();
}

class _SignupScreen_employeeState extends State<SignupScreen_employee> {
  @override
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: Material(
                            ...
                            child: InkWell(
                                onTap: () {
                                  Navigator.push(context, MaterialPageRoute(builder: (context)=>SignUpEmployee_final()));
                                },
                                child: Center(
                                  child: Text(
                                    "Sign Up",
