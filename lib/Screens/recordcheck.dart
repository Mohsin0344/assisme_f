...
class RecordCameraEmployerr extends StatefulWidget {
  @override
  _RecordCameraEmployerrState createState() => _RecordCameraEmployerrState();
}

class _RecordCameraEmployerrState extends State<RecordCameraEmployerr> {
