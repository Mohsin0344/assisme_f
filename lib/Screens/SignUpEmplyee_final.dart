...
class SignUpEmployee_final extends StatefulWidget {
  @override
  _SignUpEmployee_finalState createState() => _SignUpEmployee_finalState();
}

class _SignUpEmployee_finalState extends State<SignUpEmployee_final> {
